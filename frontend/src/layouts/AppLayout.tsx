...
export default function AppLayout() {
  ...
  return <div className="app-shell">
    ...
    <main className={`main-content main-theme-${pageTheme} app-overview-palette`}><header className="mobile-header"><Logo /><Link to="/profile" className="mobile-avatar" aria-label="Mở hồ sơ">{user?.name?.charAt(0).toUpperCase()}</Link></header><Outlet /></main>
